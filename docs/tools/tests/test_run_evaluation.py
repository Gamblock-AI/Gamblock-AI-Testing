...
class RunEvaluationReportTest(unittest.TestCase):
    ...
    def test_current_target_config_is_active(self):
        ...
        self.assertEqual(
            ["chrome", "edge", "brave", "firefox", "samsung_internet", "xiaomi_browser", "upx_browser"],
    ...
    def test_flutter_report_renders_client_runtime_contracts(self):
        ...
        self.assertIn("Chrome, Edge, Brave, Firefox, Samsung Internet, Xiaomi Browser, Upx Browser", report)
