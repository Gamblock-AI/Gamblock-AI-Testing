...
This report covers offline model evidence and runtime projection only.

## Model replay

| Status | Evidence maturity | Test rows |
|---|---|---:|
| pending | not generated | not generated |

## Runtime projection

| Status | Accuracy | Precision | Recall | F1 | False-positive rate |
|---|---:|---:|---:|---:|---:|
| pending | not generated | not generated | not generated | not generated | not generated |

## Component checks

| Check | Status |
|---|---|
| model_tooling_unit | pending |
